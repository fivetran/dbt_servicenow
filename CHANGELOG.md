...
## Feature Updates
- Introduces the new (recommended) `servicenow_sources` variable for more robust union data configuration. The old `servicenow_union_schemas` and `servicenow_union_databases` variables will still be supported. See the [README](https://github.com/fivetran/dbt_servicenow/tree/main#define-database-and-schema-variables) for specific details.

## Under the Hood
- Adds the `fivetran_using_source_casing` variable for case-sensitive destination support. When enabled, downstream transformations respect source casing to ensure consistent results. See the [Additional Configurations](https://github.com/fivetran/dbt_servicenow/#source-casing-for-case-sensitive-destinations) section of the README for details.
...
# dbt_servicenow v0.8.0

[PR #26](https://github.com/fivetran/dbt_servicenow/pull/26) includes the following updates:
