...
final as (
    select 
        ...
        _fivetran_deleted,
        _fivetran_synced,
        cast(category as {{ dbt.type_string() }}) as problem_category,
        cause_notes,
        ...
        cast(problem_state as {{ dbt.type_string() }}) as problem_state,
        ...
        cast(resolution_code as {{ dbt.type_string() }}) as problem_resolution_code,
        ...
        cast(subcategory as {{ dbt.type_string() }}) as problem_subcategory,
        workaround,
        workaround_applied,
