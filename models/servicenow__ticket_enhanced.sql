...
select 
  ...
  task.closed_at,
  TIMESTAMP_DIFF(task.closed_at, task.sys_created_at, minute) as task_minutes_to_close,
  task.closed_by_link,
  ...
  problem_task_starter.name as problem_task_starter_name,
  ...
  problem_confirmer.name as problem_confirmer_name,
  ...
  problem_reporter.name as problem_reporter_name,
  ...
  problem_fixer.name as problem_fixer_name,
  ...
  problem_resolver.name as problem_resolver_name,
  problem_resolver.roles as problem_resolver_roles,
  problem.problem_subcategory,
  problem.sys_created_at as problem_sys_created_at,
  problem.sys_updated_at as problem_sys_updated_at,
  dbt.date_diff(problem.sys_created_at, problem.problem_resolved_at, minute) as problem_minutes_to_resolve,
  change_task.change_task_type,
  change_task.change_task_close_code,
  change_task.change_task_created_from,
  change_task.change_on_hold,
  ...
  change_request.change_category,
  change_request.change_plan,
  change_request.change_close_code,
  change_request.change_end_date,
  change_request.change_implementation_plan,
  change_request.change_justification,
  change_request.change_on_hold,
  change_request.change_on_hold_reason,
  change_request.change_phase,
  change_request.change_phase_state,
  ...
  change_requester.name as change_requester_name,
  change_requester.roles as change_requester_roles,
  change_request.change_review_date,
  change_request.change_review_status,
  change_request.change_risk,
  change_request.change_scope,
  change_request.change_start_date,
  change_request.change_type

from task
left join problem_task
  on task.task_id = problem_task.task_id
...
left join change_task
  on task.task_id = change_task.task_id
